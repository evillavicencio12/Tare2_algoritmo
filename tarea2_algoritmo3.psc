...
Funcion ejercicio32
    ...
    Mientras Verdadero
        Escribir "Ingrese la categoría del profesor o escriba salir para terminar: "
        Leer categoria
    ...
    Si contador > 0 Entonces
        Escribir "Promedio de sueldos: ", sumaSueldos / contador
        Escribir "Promedio de bonos: ", sumaBonos / contador
    FinSi
